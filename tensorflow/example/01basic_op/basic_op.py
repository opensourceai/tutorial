...
with tf.Session() as sess:
    print("a=2, b=3")
    print("加法操作: ", sess.run(a + b))
    print("加法操作: ", sess.run(tf.add(a, b)))

    print("减法操作: ", sess.run(a - b))
    print("减法操作: ", sess.run(tf.subtract(a, b)))

    print("乘法操作: ", sess.run(a * b))
    print("乘法操作: ", sess.run(tf.multiply(a, b)))

    print("除法操作: ", sess.run(a / b))
    print("除法操作: ", sess.run(tf.divide(a, b)))
...
c = tf.placeholder(tf.float32, shape=[1])  # 传入一个32位浮点数
